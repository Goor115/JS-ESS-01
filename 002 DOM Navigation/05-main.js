...
let emailOut = document.querySelector("#emailAddressesOutput");
let countOut = document.querySelector("#greatesFriendsCountOutput");
let greaCompanyOut = document.querySelector("#greatestBalanceCompanyOutput");
let lowCompanyOut = document.querySelector("#lowestBalanceCompanyOutput");


function showAllEmails() {
    let output = "";
    users.forEach(user => output += user.email + "<br />");
    emailOut.innerHTML = output;
...
function showHigestFriendCount() {
    ...
    users
        ...
        .forEach(user => output += user.name.first + " " + user.name.last + "<br />");
    countOut.innerHTML = output;
...
function showMinMaxBalance() {
    ...
    users
        ...
        .forEach(user => greaCompanyOut.textContent = user.company);


    users
        .filter(user => user.balance == minBalance)
        .forEach(user => lowCompanyOut.textContent = user.company);
